...
```{r figName41a, echo=FALSE, message=FALSE, warning=FALSE, out.width = "85%", fig.cap = "Example 2: the least square estimate is represented by the straight line that passes as close as possible to the observed points.", fig.dim = c(4,4)}
library(ggplot2)
